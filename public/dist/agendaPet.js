...
function isDemoMode() {
    ...
    return (previewRequested && !sessionStorage.getItem('nextstockAuthenticatedUser'));
}
...
async function init() {
    ...
    if (isDemoMode()) {
        ...
        renderEmpty('Preview público: navegação disponível. Entre em um tenant em visualização para consultar dados reais.');
        return;
    }
    try {
